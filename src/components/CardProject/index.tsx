          ...
          <div className="card-content">
            <div className="card">
              <div className="card-img">
                <img src={projeto.img} alt="Project" />
              </div>
              <div className="card-infos">
                <div className="card-infos-up">
                  <h1>{projeto.title}</h1>
                  <div className="card-infos-description">
                    <p>{projeto.description}</p>
                  </div>
                </div>
                <div className="card-infos-down-techs">
                  {projeto.skills.map((e) => (
                    <SkillCard skill={e} />
                  ))}
                </div>
                <div className="card-infos-footer">
                  <div>
                    <svg
                    ...
                    <a target="_blank" href={projeto.linkLive}>
                      Live Preview
                    </a>
                  </div>
                  <div>
                    ...
                    <a target="_blank" href={projeto.linkRepo}>
                      View Code
                    </a>
                  </div>
                </div>
