    ...
    <>
      <footer>
        <div className="footer-container">
          <div>
            <h1 className="footer-title">LeandroRocha.</h1>
          </div>
          <div className="nav-items-up">
            <ul>
              <li>
                <a href="https://wa.me/799883533265">+55 79 98835-3265 </a>
              </li>
              <li>
                <a href="mailto:lerocha644@gmail.com">lerocha644@gmail.com</a>
              </li>
            </ul>
          </div>
          <div className="nav-icons-footer">
            ...
            <a
              href="https://www.linkedin.com/in/leandrorocha-/"
              target="_blank"
            >
              <svg
                xmlns="http://www.w3.org/2000/svg"
      ...
      <div className="footer-container-down">
        ...
        <div className="footer-text-down">
          <p>
            © 2023 <strong> Leandro Rocha S. </strong> All rights reserved.
          </p>
        </div>
      </div>
    </>
